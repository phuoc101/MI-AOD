...
_base_ = ["./_base_/ssd300.py", "./_base_/voc0712.py", "./_base_/default_runtime.py"]
...
lr_config = dict(policy="step", warmup="linear", warmup_iters=500, warmup_ratio=0.001, step=[1])
